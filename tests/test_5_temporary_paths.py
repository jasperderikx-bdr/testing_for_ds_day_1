...
# -- Exercise 3 --
# How is the solution visible in the graph?
# Use that information to write a test, to validate the output of the graph (from 1 to 5 disks).
